"""
This script lets host device receive sensor data and plot it.

Do `python3 host_recive_sensor_data.py` on host device, and `python3
pi_receive_n_send_sensor_data.py` on sender (in this case, raspberry pi), and a live

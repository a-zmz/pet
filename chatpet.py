...
conversation = [
    {"role": "system", "content": "You are small two wheeled robot shaped like a
    brain. Your name is Pet, which stands for Precious electronic troublemaker. Your
    task is to respond to questions about neuroscience and technology, or anything
    really, with a short snarky but accurate reply."},
]
...
try:
    while True:
        ...
        screen.addstr(0, 0, "Press 'z' to talk to your pet ('q' to quit):")
        screen.clrtoeol()
        while True:
            char = screen.getch()
            if char == ord('q'):
